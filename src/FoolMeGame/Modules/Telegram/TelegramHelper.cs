...
public class TelegramHelper
{
    ...
    public Task SendStatusAsync(ChatAction action)
    {
        var chatId = _message?.Chat.Id ?? _callbackQuery?.Message?.Chat.Id;
        if (chatId == null)
        {
        ...
        return _telegram.SendChatAction(chatId, action);
    }
    ...
    public Task EditMessageAsync(int messageId, long chatId, string text,
        ParseMode parseMode = ParseMode.Html,
        InlineKeyboardMarkup? replyMarkup = null,
        LinkPreviewOptions? linkPreviewOptions = null,
        IEnumerable<MessageEntity>? entities = null) =>
        _telegram.EditMessageText(chatId, messageId, text, parseMode, entities, linkPreviewOptions, replyMarkup);
